...
test("PROJECT.md validation is shallow but requires operative headings", () => {
  const valid = validateProjectMarkdown("# Project\n\n## Objective\nX\n## Current direction\nY\n## Definition of done\nZ\n");
...
test("evidence helpers extract bounded entry metadata", () => {
  ...
  assert.deepEqual(entries, [
    { id: "E-014", title: "A finding", status: "supported", kind: "empirical result", source: "outputs/model.html" },
    { id: "E-015", title: "A limitation", status: "unresolved", kind: undefined, source: undefined },
  ]);
});
