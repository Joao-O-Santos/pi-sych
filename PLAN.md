...
This plan tracks the remaining failure-mode-driven v7 work. Keep the
package small: solve repeated observed failures with the least prompt and
runtime surface that works, then watch for regressions.
