...
- Fixed unit tests that depend on a Pi Sych configuration directory
  to create a temporary agent directory when none exists, so the tests
  pass in CI containers without user configuration.
