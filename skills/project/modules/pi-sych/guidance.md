...
Read configured canonical roles before proposing state; their definitions
live with the [artifacts](../artifacts/guidance.md) module. Use `project_status`
to inspect or acknowledge reviewed state, never as proof of correctness.
For an `agents` promotion, show the configured project path, personal Pi path,
rationale, and required owner scope choice.
