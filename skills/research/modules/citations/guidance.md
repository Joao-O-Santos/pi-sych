...
Check claim-to-source alignment, provenance, quotation accuracy, and retrieval limits. Cite what the source actually supports and identify claims that still need a source.
## Practice
