---
name: writing-core
description: Develop clear, audience-aware writing through argument-first planning and revision rather than formulaic prose rules.
---
...
2. In a messy draft, make a **reverse outline**: state what each existing
   ...
   editing.
3. Give most substantive paragraphs one job: a claim, the reasoning or evidence
   for it, and a sentence that explains its consequence or transition. Short
   bridge paragraphs are valid when they genuinely bridge.
...
paragraph that follows. Preserve intentional fragments, dialogue, informal
voice, uncertainty markers, verified citations, and placeholders.
