...
complexity. Identify unapproved changes and unresolved human decisions. When
structure or coherence has genuinely degraded, ask whether a clean rewrite
would be safer or simpler than the accumulated edits.
...
the artifact with relevant source and rendered output. Default to reporting
**pass**, **revise**, or **reject** with concrete corrections, unless another
