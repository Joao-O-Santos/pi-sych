---
name: scholarly-manuscript
description: Develop scholarly manuscripts with a visible contribution, evidence discipline, section-aware argument, and global coherence.
---
...
- Make a topic-sentence outline before drafting; reverse-outline before a major
  rewrite. Organize the introduction and literature review by claims or
  theoretical tensions, never author-by-author chronology.
- Open with the concrete problem, puzzle, or consequence that makes the paper
  matter. Surface competing perspectives fairly; a gap is often what existing
  perspectives miss, not merely an unstudied topic.
- Make the contribution and scope conditions explicit by the end of the
  introduction. Distinguish a proposition, an empirical finding, an
  interpretation, and a speculation.
